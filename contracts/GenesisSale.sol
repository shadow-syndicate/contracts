...
contract GenesisSale is Operators {
    ...
    /// @dev function check signature, generated by backend for buyer account according to whitelist limitations
    /// @dev can be called twice if total minted token count doesn't exceed limitForAccount
